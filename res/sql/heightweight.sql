...
UPDATE heightweight SET weight_first = inputevents_mv.patientweight
FROM inputevents_mv WHERE inputevents_mv.icustay_id = heightweight.icustay_id
AND heightweight.weight_first IS NULL;