...
# cursor.execute(
#     'DROP TABLE IF EXISTS ' + table_name + '_creatinine_chart;'
#     + 'CREATE TABLE ' + table_name + '_creatinine_chart AS (SELECT chartevents.subject_id, chartevents.hadm_id, charttime, valuenum FROM chartevents,' + table_name
#     + ' WHERE chartevents.hadm_id = ' + table_name + '.hadm_id);'
# )
# conn.commit()
